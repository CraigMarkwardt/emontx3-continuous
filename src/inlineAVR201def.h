...
// *
// ******************************************************************************
#define mul16x16_16(result, multiplicand, multiplier) \
...
// *
// ******************************************************************************
#define mul16x16_32(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" clr r2 \n\t" \
" mul %B2, %B1 \n\t" /* ah * bh*/ \
" movw  %C0, r0 \n\t" \
...
// *
// ******************************************************************************
#define mul16x16_24(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" mul   %B2, %B1 \n\t" /* ah * bh*/ \
" mov   %C0, r0 \n\t" \
" mul   %A2, %A1 \n\t" /* al * bl*/ \
...
// *
// ******************************************************************************
#define muls16x16_24(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" muls  %B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
" mov   %C0, r0 \n\t" \
" mul   %A2, %A1 \n\t" /* al * bl*/ \
...
// *
// ******************************************************************************
#define mac16x16_24(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" muls  %B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
" add %C0, r0 \n\t" \
" mul %A2, %A1 \n\t" /* al * bl*/ \
...
// *
// ******************************************************************************
#define mac16x16_32(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" clr r2 \n\t" \
" muls  %B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
" add %C0, r0 \n\t" \
...
#define mac16x16_32_method_B(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" clr r2 \n\t" \
" muls  %B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
" movw  r4,r0 \n\t" \
...
// *
// ******************************************************************************
#define fmuls16x16_32(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" clr r2 \n\t" \
...
// *
// ******************************************************************************
#define fmac16x16_32(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" clr r2 \n\t" \
" fmuls %B2, %B1 \n\t" /* ( (signed)ah * (signed)bh ) << 1*/ \
" add %C0, r0 \n\t" \
...
#define fmac16x16_32_method_B(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
" clr r2 \n\t" \
" clr r2 \n\t" \
" fmuls %B2, %B1 \n\t" /* ( (signed)ah * (signed)bh ) << 1*/ \
